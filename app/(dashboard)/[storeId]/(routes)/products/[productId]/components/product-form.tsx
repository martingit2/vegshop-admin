...
export const ProductForm: React.FC<ProductFormProps> = ({
    ...
    const description = initialData ? "Rediger et produkt" : "Legg til en ny produkt";
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    >
                                        <FormControl>
                                            <SelectTrigger>
                                                <SelectValue defaultValue={field.value} placeholder="Velg størrelse"/>
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    >
                                        <FormControl>
                                            <SelectTrigger>
                                                <SelectValue defaultValue={field.value} placeholder="Velg farge"/>
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                                    ...
                                    <div className="space-y-1 leading-none">
                                        ...
                                        <FormDescription>
                                           Dette produktet vil bli fremhevet på forsiden
                                        </FormDescription>
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                                    ...
                                    <div className="space-y-1 leading-none">
                                        ...
                                        <FormDescription>
                                           Dette produktet vil ikke bli vist i butikken lenger.
                                        </FormDescription>
